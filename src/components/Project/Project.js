...
const Project = () => {
  const projectData = [
    {
      sourceCodeLink: "https://github.com/YuvrajChoudharyJnu/Blinkit",
      deployedLink: "https://yuvrajjat70770.github.io/Blinkit-clone/",
      name: "Blinkit Clone",
      description:
        "Developed a full-stack clone of Blinkit with cart management, user auth, and service booking.Integrated Stripe for payments, Cloudinary for image upload, and Twilio/Resend for OTP/email verification.Built RESTful APIs using Node.js + Express, and used MongoDB Atlas for data persistence.",
      languages: "JavaScript | React.js | React Flow | Node.js | Express.js | MongoDB | Mongoose | Twilio API | APIs | MERN Stack",
      image: FlowBuilder,
      projectType: "Full Stack App",
    },
    {
      sourceCodeLink: "https://github.com/YuvrajChoudharyJnu/Shopping-Website",
    ...
    {
      sourceCodeLink: "https://github.com/YuvrajChoudharyJnu",
